...
2. World Health Organization. **Physical activity — Fact sheet** (atualização disponível em 2024). https://www.who.int/news-room/fact-sheets/detail/physical-activity
...
- adultos devem trabalhar os grandes grupos musculares ao menos duas vezes por semana como referência de saúde geral;
- qualquer atividade é melhor que nenhuma e a progressão deve respeitar capacidade;
...
Os números exatos de séries, RPE, critérios de domínio, XP, deload, níveis e intervalos de reavaliação deste pacote são propostas de produto. Devem ser validados em revisão profissional, testes de usabilidade e piloto antes de uso em produção.

## 4. Política de atualização

- revisar referências ao menos anualmente;
- registrar data, responsável e impacto da atualização;
- criar nova versão de regra quando uma mudança afetar prescrição;
- nunca reescrever silenciosamente decisões históricas;
- usar fontes primárias, institucionais e documentos de consenso;
- não basear regra crítica apenas em influenciadores ou conteúdo comercial.
